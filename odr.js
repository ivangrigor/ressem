window.addEventListener('load', function () {
    ...
    function callWebService() {
        ...
        jQuery.ajax({
            url: "https://odr-test.azure-api.net/cmboys",
            beforeSend: function (xhrObj) {
                xhrObj.setRequestHeader("Content-Type", "application/json;charset=utf-8");
                xhrObj.setRequestHeader("Ocp-Apim-Subscription-Key", "rvyvtg3a+2yBNsmDACqU9aJKPYsmzkplbxBWit4B3iEITqlKD3pkDeQu7eWcupUEDHnspmHy3ImtewtwjYZO4w==");
